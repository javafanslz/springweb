...
*/
	 ...
	 * 状态变更
     */
    BGZQ.prototype.validateStateChange = function(){
    	var stateChange = $("#field0127_txt").val();
        if(!this.isEmptyStr(stateChange)&&$.trim(stateChange)=='业务终止'){
        	var xiaXian = $("#field0175").val();
        	if(xiaXian==null||typeof (xiaXian)=="undefined"||$.trim(xiaXian)==''){
        		alert('[下线原因]请填写下线原因!');
                $("#field0175").focus();
                return false;
			}
			var kaiPiao = $("input[name=field0176]").is(":checked");
        	if(!kaiPiao){
        		alert('[开票情况]必须选择一种开票情况！');
        		return false;
			}
            var huiKuan = $("input[name=field0179]").is(":checked");
        	if(!huiKuan){
                alert('[回款情况]必须选择一种回款情况！');
                return false;
			}
			var weiJieSuan =  $("input[name=field0182]").is(":checked");
            if(!weiJieSuan){
                alert('[未结算情况]必须选择一种未结算情况！');
                return false;
            }
            var zhuanXian =  $("input[name=field0187]").is(":checked");
            if(!zhuanXian){
                alert('[有无专线]必须选择一种专线情况！');
                return false;
            }
            var zhongJi =  $("input[name=field0190]").is(":checked");
            if(!zhongJi){
                alert('[有无中继]必须选择一种中继情况！');
                return false;
            }
            var jiGui =  $("input[name=field0193]").is(":checked");
            if(!jiGui){
                alert('[有无机柜]必须选择一种机柜情况！');
                return false;
            }
            var haoMa = $("input[name=field0195]").is(":checked");
            if(!haoMa){
                alert('[有无号码]必须选择一种号码情况！');
                return false;
            }
	 ...
	 * 状态变更
     */
    BGZQ.prototype.ztbg = function(){
    	var changeState = $("#field0127_txt").attr('title');
    	if(!this.isEmptyStr(changeState)&&$.trim(changeState)=='业务终止'){
            /**下线原因*/
    		$("#field0175").attr("disabled",false);
    		/**开票情况*/
    		$("input[name=field0176]").attr("disabled",false);
            $("#field0177_txt").attr("disabled",false);
            $("#field0178_txt").attr("disabled",false);
    		/**回款情况*/
            $("input[name=field0179]").attr("disabled",false);
            $("#field0180_txt").attr("disabled",false);
            $("#field0181_txt").attr("disabled",false);
            /**未结算情况*/
            $("input[name=field0182]").attr("disabled",false);
            $("#field0183_txt").attr("disabled",false);
            $("#field0184_txt").attr("disabled",false);
            $("#field0185_txt").attr("disabled",false);
            $("#field0186_txt").attr("disabled",false);
            /**成本情况 有无专线*/
            $("input[name=field0187]").attr("disabled",false);
            $("#field0188").attr("disabled",false);
            /**有无中继*/
            $("input[name=field0190]").attr("disabled",false);
            $("#field0191").attr("disabled",false);
            /**有无机柜*/
            $("input[name=field0193]").attr("disabled",false);
            $("#field0194").attr("disabled",false);
            /**有无号码*/
            $("input[name=field0195]").attr("disabled",false);
            $("#field0189").attr("disabled",false);
            /**话批公司名称*/
            $("#field0197").attr("disabled",false);
            /**号码个数*/
            $("#field0198").attr("disabled",false);
            /**其他成本*/
            $("#field0192").attr("disabled",false);
            /**上传的附件*/
            $("#field0196_span").attr("disabled",false);

		}else{
            /**下线原因*/
            $("#field0175").attr("disabled",true);
            /**开票情况*/
            $("input[name=field0176]").attr("disabled",true);
            $("#field0177_txt").attr("disabled",true);
            $("#field0178_txt").attr("disabled",true);
            /**回款情况*/
            $("input[name=field0179]").attr("disabled",true);
            $("#field0180_txt").attr("disabled",true);
            $("#field0181_txt").attr("disabled",true);
            /**未结算情况*/
            $("input[name=field0182]").attr("disabled",true);
            $("#field0183_txt").attr("disabled",true);
            $("#field0184_txt").attr("disabled",true);
            $("#field0185_txt").attr("disabled",true);
            $("#field0186_txt").attr("disabled",true);
            /**成本情况 有无专线*/
            $("input[name=field0187]").attr("disabled",true);
            $("#field0188").attr("disabled",true);
            /**有无中继*/
            $("input[name=field0190]").attr("disabled",true);
            $("#field0191").attr("disabled",true);
            /**有无机柜*/
            $("input[name=field0193]").attr("disabled",true);
            $("#field0194").attr("disabled",true);
            /**有无号码*/
            $("input[name=field0195]").attr("disabled",true);
            $("#field0189").attr("disabled",true);
            /**话批公司名称*/
            $("#field0197").attr("disabled",true);
            /**号码个数*/
            $("#field0198").attr("disabled",true);
            /**其他成本*/
            $("#field0192").attr("disabled",true);
            /**上传附件*/
            $("#field0196_span").attr("disabled",true);
            /**--------------------------------------------*/
            /**下线原因*/
            $("#field0175").val("");
            /**开票情况*/
            $("input[name=field0176]").each(function(){
                $(this).attr("checked", false);
			});
            $("#field0177_txt").val("");
            $("#field0178_txt").val("");
            /**回款情况*/
            $("input[name=field0179]").each(function(){
                $(this).attr("checked", false);
            });
            $("#field0180_txt").val("");
            $("#field0181_txt").val("");
            /**未结算情况*/
            $("input[name=field0182]").each(function(){
                $(this).attr("checked", false);
            });
            $("#field0183_txt").val("");
            $("#field0184_txt").val("");
            ...
            $("#field0186_txt").val("");
            /**成本情况 有无专线*/
            $("input[name=field0187]").each(function(){
                $(this).attr("checked", false);
            });
            $("#field0187").val("");
            /**有无中继*/
            $("input[name=field0190]").each(function(){
                $(this).attr("checked", false);
            });
            $("#field0191").val("");
            /**有无机柜*/
            $("input[name=field0193]").each(function(){
                $(this).attr("checked", false);
            });
            $("#field0194").val("");
            /**有无号码*/
            $("input[name=field0195]").each(function(){
                $(this).attr("checked", false);
            });
            $("#field0188").val("");
            $("#field0189").val("");
            ...
            var telResource = $("#field0196_span").children(":first").next();
            var agentTelChilds = telResource.children();
            if(agentTelChilds!=null&&agentTelChilds.length!=0){
                agentTelChilds.html("");
            }
		}
	};
    ...
    BGZQ.prototype.elements = {
		...
		/**下线客户清单检查*/
        "field0175":{id : "field0175",	type : "text",		name : "下线原因",initDisable:true},
		/**开票情况*/
        "field0176":{id : "field0176",	type : "radio",		name : "试用客户不涉及",initDisable:true},
        "field0176":{id : "field0176",	type : "radio",		name : "计费客户从未开票",initDisable:true},
        "field0176":{id : "field0176",	type : "radio",		name : "已开票账期",initDisable:true},
        "field0177_txt":{id : "field0177_txt",	type : "text",		name : "年",initDisable:true},
        "field0178_txt":{id : "field0178_txt",	type : "text",		name : "月",initDisable:true},
		/**回款情况*/
        "field0179":{id : "field0179",	type : "radio",		name : "试用客户不涉及",initDisable:true},
        "field0179":{id : "field0179",	type : "radio",		name : "计费客户从未回款",initDisable:true},
        "field0179":{id : "field0179",	type : "radio",		name : "已回款账期",initDisable:true},
        "field0180_txt":{id : "field0180_txt",	type : "text",		name : "年",initDisable:true},
        "field0181_txt":{id : "field0181_txt",	type : "text",		name : "月",initDisable:true},
		/**未结算情况*/
        "field0182":{id : "field0182",	type : "radio",		name : "试用客户不涉及",initDisable:true},
        "field0182":{id : "field0182",	type : "radio",		name : "已全部结清",initDisable:true},
        "field0182":{id : "field0182",	type : "radio",		name : "未结算账期",initDisable:true},
        "field0183_txt":{id : "field0183_txt",	type : "text",		name : "年",initDisable:true},
        "field0184_txt":{id : "field0184_txt",	type : "text",		name : "月",initDisable:true},
        "field0185_txt":{id : "field0185_txt",	type : "text",		name : "至年",initDisable:true},
        "field0186_txt":{id : "field0186_txt",	type : "text",		name : "至月",initDisable:true},
        /**成本情况*/
        "field0187":{id : "field0187",	type : "radio",		name : "有",initDisable:true},
        "field0187":{id : "field0187",	type : "radio",		name : "无",initDisable:true},
        "field0188":{id : "field0188",	type : "text",		name : "备注",initDisable:true},
		/**有无中继*/
        "field0190":{id : "field0190",	type : "radio",		name : "有",initDisable:true},
        "field0190":{id : "field0190",	type : "radio",		name : "无",initDisable:true},
        "field0191":{id : "field0191",	type : "text",		name : "备注",initDisable:true},
        /**有无机柜*/
        "field0193":{id : "field0193",	type : "radio",		name : "有",initDisable:true},
        "field0193":{id : "field0193",	type : "radio",		name : "无",initDisable:true},
        "field0194":{id : "field0194",	type : "text",		name : "备注",initDisable:true},
        /**有无号码*/
        "field0195":{id : "field0195",	type : "radio",		name : "有",initDisable:true},
        "field0195":{id : "field0195",	type : "radio",		name : "无",initDisable:true},
        "field0189":{id : "field0189",	type : "text",		name : "备注",initDisable:true},
		/**号码来源*/
        "field0197":{id : "field0197",	type : "text",		name : "话批公司名称",initDisable:true},
        "field0198":{id : "field0198",	type : "text",		name : "号码个数",initDisable:true},
		"field0196_span":{id : "field0196_span",	type : "span",		name : "注销的成本号码附件",initDisable:true},

		/**其他成本*/
        "field0192":{id : "field0192",	type : "text",		name : "号码个数",initDisable:true},
        /**状态变更*/
        "field0127_txt":{id : "field0127_txt",	type : "text",		name : "状态变更"}
    ...
    BGZQ.prototype.events = {
       ...
       /* "field0127_txt":{event:"change",func:"ztbg"}*/
    };
     ...
     * @returns {boolean}
     */
    BGZQ.prototype.isEmptyStr = function(str){
